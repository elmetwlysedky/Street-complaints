...
<div class="card">
    <div class="card-header header-elements-inline">
        <h5 class="card-title">Problem Destination Table</h5>
    ...
    <div class="card-body">
        ...
        <a href="{{route('Problem_Destination.create')}}">
    ...
    <table class="table datatable-basic">
            ...
            <div>
                @foreach ($Problem_Destination as $item )
                <tr>
                    <td>{{$item->name}}</td>
                    ...
                    <td>
                        <div class="list-icons">
                            <div class="list-icons-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="{{route('Problem_Destination.show',[$item->id])}}" class="dropdown-item"><i class="icon-file-eye2 mr-3 icon"></i> show </a>
                                    <a href="{{route('Problem_Destination.edit',$item->id)}}" class="dropdown-item"><i class="icon-pencil7"></i> Edit </a>

                                    <div class="dropdown-divider"></div>
                                    <form action="{{route('Problem_Destination.destroy',$item->id)}}" method="POST"  >
                                        @csrf
                                        @method('DELETE')
