...
<div class="card">
    <div class="card-header header-elements-inline">
        <h5 class="card-title">Reason Table</h5>
                    ...
                    <td>
                        <div class="list-icons">
                            <div class="list-icons-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="{{route('Reason.show',[$item->id])}}" class="dropdown-item"><i class="icon-file-eye2 mr-3 icon"></i> show </a>
                                    <a href="{{route('Reason.edit',$item->id)}}" class="dropdown-item"><i class="icon-pencil7"></i> Edit </a>

                                    <div class="dropdown-divider"></div>
                                    <form action="{{route('Reason.destroy',$item->id)}}" method="POST"  >
                                        @csrf
                                        @method('DELETE')
