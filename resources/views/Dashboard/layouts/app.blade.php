...
<head>
    ...
    <title>Streets @yield('title')</title>
            ...
            <div class="card card-sidebar-mobile">
                <ul class="nav nav-sidebar" data-nav-type="accordion">
                    ...
                    <li class="nav-item nav-item-submenu">
                        <a href="#" class="nav-link"><i class="icon-city icon"></i> <span>Cities</span></a>

                        <ul class="nav nav-group-sub" data-submenu-title="Layouts">
                            <li class="nav-item"><a href="{{route('city.index')}}" class="nav-link active">List City</a></li>
                            <li class="nav-item"><a href="{{route('city.create')}}" class="nav-link">Add City</a></li>
                           </ul>
                    </li>
                    <li class="nav-item nav-item-submenu">
                        <a href="#" class="nav-link"><i class="icon-construction mr-3 icon"></i> <span>Problem</span></a>
                    ...
                    <li class="nav-item nav-item-submenu">
                        <a href="#" class="nav-link"><i class="icon-link mr-3 icon"></i> <span>Problem Destinations</span></a>

                        <ul class="nav nav-group-sub" data-submenu-title="Starter kit">
                            <li class="nav-item"><a href="{{route('Problem_Destination.index')}}" class="nav-link">List Destinations</a></li>
                            <li class="nav-item"><a href="{{route('Problem_Destination.create')}}" class="nav-link">Create Problem Destinations</a></li>
                        </ul>

                            <li class="nav-item nav-item-submenu">
                        <a href="#" class="nav-link"><i class="icon-paste2 mr-3 icon"></i><span>Reasons Problem</span></a>
                                <ul class="nav nav-group-sub">
                                    <li class="nav-item"><a href="{{route('Reason.index')}}" class="nav-link">List Reasons</a></li>
                                    <li class="nav-item"><a href="{{route('Reason.create')}}" class="nav-link">Create Reason</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="nav-item nav-item-submenu">
                                ...
                                <ul class="nav nav-group-sub">
                                    <li class="nav-item"><a href="{{route('Item.index')}}" class="nav-link">List Item</a></li>
                                    <li class="nav-item"><a href="{{route('Item.create')}}" class="nav-link">Create Item</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="nav-item nav-item-submenu">
                                ...
                                <ul class="nav nav-group-sub">
                                    <li class="nav-item"><a href="{{route('Blog.index')}}" class="nav-link">List Blogs</a></li>
                                    <li class="nav-item"><a href="{{route('Blog.create')}}" class="nav-link">Create Blog</a></li>
                                </ul>
                            </li>

                            <li class="nav-item nav-item-submenu">
                                <a href="#" class="nav-link"><i class="icon-image3 mr-3 icon"></i><span>Splash</span></a>
                                <ul class="nav nav-group-sub">
                                    <li class="nav-item"><a href="{{route('Splash.index')}}" class="nav-link">List Splashes</a></li>
                                    <li class="nav-item"><a href="{{route('Splash.create')}}" class="nav-link">Create Splash</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="nav-item nav-item-submenu">
                                <a href="#" class="nav-link"><i class="icon-clipboard3 mr-3 icon"></i><span>Terms and Condition</span></a>
                                <ul class="nav nav-group-sub">
                                    <li class="nav-item"><a href="{{route('Terms_and_condition.index')}}" class="nav-link">List Condition</a></li>
                                    <li class="nav-item"><a href="{{route('Terms_and_condition.create')}}" class="nav-link">Create Condition</a></li>
                                </ul>
                            </li>
